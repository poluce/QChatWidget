...
void MainWindow::onThemeChanged()
{
    ...
    if (isDark) {
        setStyleSheet("QMainWindow { background-color: #1a1a1a; } "
                      "QPushButton { background-color: #333; color: #eee; border: none; padding: 8px; border-radius: 4px; } "
                      "QPushButton:hover { background-color: #444; }");
    } else {
        setStyleSheet("QMainWindow { background-color: #f5f5f5; } "
                      "QPushButton { background-color: #fff; color: #333; border: 1px solid #ddd; padding: 8px; border-radius: 4px; } "
